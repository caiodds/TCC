			...
			<div id="overlay-1">
					...
					<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	  					<div class="container-fluid">
	    					<div class="navbar-header">
					      		...
					      		<!-- <a class="navbar-brand" href="#">APD</a> -->
								  <a class="navbar-brand" href="#"><img class="img-responsive" src="img/3-col-icons-web.png" height="80px" width="100px"></a>
					    	</div>
				...
				<section id="starting">
					<div class="text-center starting-text">
						<h1 class="rene">Assistência psicologica ao Docente</h1>
						<h2>Bem-vindo a nossa página de Download</h2>
					</div>
				</section>
